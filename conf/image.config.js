...
module.exports = {
  ...
  IMAGE_COMPRESS_WIDTH: process.env.NEXT_PUBLIC_IMAGE_COMPRESS_WIDTH || 1024, // 图片压缩宽度默认值，作用于博客封面和文章内容 越小加载图片越快
  ...
  IMG_SHADOW: process.env.NEXT_PUBLIC_IMG_SHADOW || true, // 文章图片是否自动添加阴影，提升视觉效果
