...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '252681d1cc1380608980c104cc3fe300', // 您的Notion数据库ID
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'yanyu920', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '大数据开发工程师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yanyu920.fun', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'yanyu920, 大数据, Kubernetes, Docker, Spark, 技术博客, 后端开发', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是yanyu920, 专注大数据开发, 分享Kubernetes经验, 探索云原生技术, 欢迎来到我的技术博客🎉',
